...
annovar_header=/mnt/projects/liuxl/ctso4_projects/liuxl/scripts/github/LoFreq_indelovlp_filtervcf_vcf2avinput_annovar/Annovar_header_lofreq2_1_2.txt
...
if [[ $vartype != "" ]] 
then
    java -Xmx$Xmx -XX:+UseSerialGC -cp /mnt/projects/liuxl/ctso4_projects/liuxl/scripts/github/LoFreq_indelovlp_filtervcf_vcf2avinput_annovar:. LoFreqVCF2Avinput_lofreq2_1_2 $vcf > $vcf.avinput
